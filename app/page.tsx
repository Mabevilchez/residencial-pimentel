      ...
      <div className="container-narrow">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="font-sans text-base text-charcoal/75 leading-relaxed mb-12 max-w-lg">Un proyecto residencial de nueve pisos ubicado en el Malécón de Pimentel. Sus departamentos han sido diseñados para ofrecer vistas y confort.</p>
...
function WhySection() {
  const reasons = [
    { number: "01", title: "Ubicación privilegiada", text: "En la primera fila del Malécón de Pimentel, a pocos pasos de la playa, el muelle histórico y los principales puntos de interés." },
    { number: "02", title: "Vistas directas al mar y al muelle", text: "El proyecto integra el océano a la vida cotidiana, con vistas desde el dormitorio principal, la sala y los espacios exteriores." },
    { number: "03", title: "Inversión inteligente", text: "Una propiedad en una zona de alta plusvalía, a solo 15 minutos de Chiclayo, dentro de un entorno tranquilo y exclusivo.", image: "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=900&q=85" },
  ];
  return (
...
function ImageBreak() {
  return (
    <section className="relative w-full min-h-[60vh] flex items-center justify-start overflow-hidden">
      ...
      <div className="relative z-10 px-6 pt-12 pb-24"><h2 className="font-serif text-4xl md:text-6xl font-light text-white max-w-4xl">Donde cada día empieza y termina cerca del mar</h2></div>
    </section>
  );
}
          ...
          <div className="relative aspect-[4/3] bg-beige border border-sand overflow-hidden flex items-center justify-center">
            <div className="text-center p-8">
              ...
              <div className="flex flex-wrap gap-2 mt-6 justify-center">
                {["Malécón","Playa","Muelle histórico","Club Casino","Restaurantes","Ruta Chiclayo","Aeropuerto"].map(l => (<span key={l} className="text-xs bg-ocean/10 text-ocean px-2 py-1 font-sans rounded">{l}</span>))}
              </div>
            </div>
          </div>
    ...
    <section id="duplex" className="relative section-pad bg-navy overflow-hidden">
      ...
      <div className="relative z-10 container-narrow">
        <div className="max-w-3xl">
          ...
          <p className="font-sans text-base text-white/70 leading-relaxed mb-12 max-w-xl">Solo tres dúplex con amplias terrazas privadas, vistas panorámicas al océano y espacios creados para comodidad.</p>
  ...
  return (
    <section className="section-pad bg-beige/30">
      <div className="container-narrow">
        ...
        {lightbox && (<div className="fixed inset-0 z-50 bg-navy/90 flex items-center justify-center p-8" onClick={() => setLightbox(false)}><div className="bg-beige p-12 max-w-2xl w-full text-center">Imagen del dúplex</div></div>)}
      </div>
    </section>
  );
}
    ...
    <section className="section-pad bg-warm-white">
      <div className="container-narrow">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div><p className="eyebrow mb-6">Solo en los dúplex</p><h2 className="headline-lg text-charcoal mb-8">Tu propia terraza frente al mar.</h2><div className="w-10 border-t border-sand mb-6" /></div>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="relative aspect-[3/4] overflow-hidden mt-8"><Image src="https://images.unsplash.com/photo-1566073771259-6a8506099945?w=600&q=85" alt="Vista panorámica desde terraza" fill className="object-cover" /></div>
          </div>
        </div>
      </div>
    </section>
...
function CommonAreas() {
  const areas = [
    {title:"Lobby y acceso",text:"Ingreso de diseño elegante con acabados en materiales naturales.",image:"/images/09. LOBBY RESIDENCIAL.png"},
    {title:"SUM",text:"Salón de usos múltiples para reuniones y celebraciones privadas.",image:"/images/16. SUM.png"},
    {title:"Bar-Lounge",text:"Espacio social íntimo con vistas al Malécón.",image:"/images/18. TERRAZA SUM.png"},
    {title:"Coworking",text:"Área de trabajo equipada para el profesional moderno.",image:"/images/19. COWORKING.png"},
  ];
  return (
    <section id="areas-comunes" className="section-pad bg-beige/20">
      <div className="container-narrow">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {areas.map((area) => (<div key={area.title} className="group"><div className="relative aspect-[3/4] overflow-hidden mb-4"><Image src={area.image} alt={area.title} fill className="object-cover transition-transform duration-500 group-hover:scale-105" sizes="(max-width: 1024px) 100vw" /></div><div className="border border-sand p-8 bg-warm-white"><div className="flex items-start gap-4"><UtensilsCrossed size={24} strokeWidth={1.25} className="text-ocean flex-shrink-0 mt-1" /><div><h3 className="font-serif text-lg text-charcoal mb-1">{area.title}</h3><p className="font-sans text-sm text-charcoal/70 leading-relaxed">{area.text}</p></div></div></div></div>))}
        </div>
      </div>
    </section>
  );
  ...
  return (
    <section className="section-pad bg-warm-white border-t border-b border-sand/40">
      <div className="container-narrow text-center">
        ...
        <p className="font-sans text-base text-charcoal/70 leading-relaxed max-w-2xl mx-auto mb-12">Residencial Pimentel combina ubicación, exclusividad y una propuesta arquitectónica diseñada para disfrutar.</p>
        <div className="flex flex-col sm:flex-row gap-6 justify-center mb-12">{["Primera línea frente al mar","A 15 minutos de Chiclayo","Solo 30 departamentos"].map((b) => (<div key={b} className="text-sm text-charcoal/75">{b}</div>))}</div>
