  ...
  return (
    <section id="hero" className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0">
        <Image src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=1920&q=90" alt="Costa de Pimentel al atardecer" fill priority quality={90} className="object-cover object-center" sizes="100vw" />
      ...
      <div className="relative z-10 container-narrow w-full flex flex-col items-start justify-center pt-32 pb-24">
        ...
        <p className="font-sans text-base md:text-lg font-light text-white/80 max-w-xl mb-10 leading-relaxed">Departamentos en primera línea frente al mar, diseñados para disfrutar en familia y vivir cada día con el océano como parte de tu hogar.</p>
      ...
      <div className="container-narrow">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="font-sans text-base text-charcoal/75 leading-relaxed mb-12 max-w-lg">Un proyecto residencial de nueve pisos ubicado en el Malécón de Pimentel. Sus departamentos han sido diseñados para disfrutar en familia, con vistas al océano desde el dormitorio principal y los principales espacios sociales.</p>
