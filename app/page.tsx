...
function ProjectOverview() {
  ...
  return (
    ...
    <Image src="/lobby/WhatsApp Image 2026-08-23 at 3.11.58 PM.jpeg" alt="Render exterior Residencial Pimentel" fill className="object-cover" sizes="(max-width: 1024px) 100vw" />
    </div>
